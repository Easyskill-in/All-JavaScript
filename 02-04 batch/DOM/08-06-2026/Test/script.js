...
posts.forEach((value, index) => {
    ...
    views.innerText = "👁‍🗨 " + value.views
    like.innerText = "👍 " + value.reactions.likes
    dislike.innerText = "👎 " + value.reactions.dislikes
    ...
    div1.append(views, like, dislike)
    div.append(h1, div1, Delete)
